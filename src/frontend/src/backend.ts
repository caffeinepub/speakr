...
import type { AudioPost as _AudioPost, ExternalBlob as _ExternalBlob, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addAudioPost(arg0: string, arg1: string, arg2: ExternalBlob): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.addAudioPost(arg0, arg1, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async editAudioPost(arg0: string, arg1: string, arg2: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.editAudioPost(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAudioBlob(arg0: string): Promise<ExternalBlob | null> {
        if (this.processError) {
            try {
    ...
    async getAudioPost(arg0: string): Promise<AudioPost | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getAudioPost(arg0);
    ...
    async getMyContent(): Promise<Array<AudioPost>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyContent();
    ...
    async listenToAudioPost(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.listenToAudioPost(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeAudioPost(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.removeAudioPost(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_AudioPost_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AudioPost): Promise<AudioPost> {
...
async function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_AudioPost]): Promise<AudioPost | null> {
    return value.length === 0 ? null : await from_candid_AudioPost_n14(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        title: value.title,
        audio: await from_candid_ExternalBlob_n12(_uploadFile, _downloadFile, value.audio),
...
async function from_candid_vec_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_AudioPost>): Promise<Array<AudioPost>> {
    return await Promise.all(value.map(async (x)=>await from_candid_AudioPost_n14(_uploadFile, _downloadFile, x)));
}
