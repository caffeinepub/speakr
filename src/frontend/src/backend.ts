...
import type { AudioPost as _AudioPost, ExternalBlob as _ExternalBlob, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getFavoritePosts(): Promise<Array<AudioPost>> {
        if (this.processError) {
            try {
...
async function from_candid_AudioPost_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AudioPost): Promise<AudioPost> {
...
async function from_candid_opt_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_AudioPost]): Promise<AudioPost | null> {
    return value.length === 0 ? null : await from_candid_AudioPost_n15(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        title: value.title,
        audio: await from_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.audio),
...
async function from_candid_vec_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_AudioPost>): Promise<Array<AudioPost>> {
    return await Promise.all(value.map(async (x)=>await from_candid_AudioPost_n15(_uploadFile, _downloadFile, x)));
}
