// Supported languages for SPEAKR platform
export interface Language {
  code: string;
  label: string;
}

// Comprehensive list of ISO 639-1 base languages (excluding regional variants/dialects)
// Source: ISO 639-1 standard (184 languages)
export const SUPPORTED_LANGUAGES: Language[] = [
  { code: 'none', label: 'No language (music)' },
  { code: 'aa', label: 'Afar' },
...
export function getBrowserDefaultLanguage(): string {
